...
export default function Login  ()  {
    ...
    return ( 
        <>
        <div><h1>User : {userid} </h1></div>


        <div class="min-h-screen  bg-[#121212]">
  <header class="fixed top-0 z-10 mx-auto w-full max-w-full bg-[#121212] p-6 text-white lg:px-10"><h1>DevUI</h1></header>

  <div class="mx-auto flex w-full items-stretch justify-center gap-10">
    <div class="mt-20 flex w-full flex-col items-start justify-center p-6 md:w-1/2 lg:px-10">
      <div class="w-full">
      ...
      <div class="my-14 flex w-full flex-col  justify-center gap-4">
